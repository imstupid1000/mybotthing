...
bot.on('message', function (message) {
    var g = bot.guilds.find(message.guild.id); g.channels.find(ch => ch.Name === 'bot-testing').send('Message in server was sent')
...
bot.on('messageDelete', function (message) {
    var g = bot.guilds.find(message.guild.id); g.channels.find(ch => ch.Name === 'bot-testing').send('Message in server was deleted')
...
bot.on('guildMemberAdd', function (member) {
    var g = bot.guilds.find(message.guild.id); g.channels.find(ch => ch.Name === 'bot-testing').send('Member has joined a server')
...
bot.on('guildCreate', function () {
    var g = bot.guilds.find(message.guild.id); g.channels.find(ch => ch.Name === 'bot-testing').send('Bot was added to server')
...
bot.on('guildDelete', function () {
    var g = bot.guilds.find(message.guild.id); g.channels.find(ch => ch.Name === 'bot-testing').send('Bot removed from server')
    bot.user.setActivity('' + bot.guilds.size + ' servers @Automatic help', {
        type: 'LISTENING'
    })
})
