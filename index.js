...
bot.on('message', function (message) {
    const schannel = message.guild.channels.find('624555907447259146'); schannel.send('Message in server was sent')
...
bot.on('messageDelete', function (message) {
    const guild = this.guilds.find(message.guild.id); const schannel = message.guild.channels.find('624555907447259146'); schannel.send('Message in server was deleted')
...
bot.on('guildMemberAdd', function (member) {
    const schannel = message.guild.channels.find('624555907447259146'); schannel.send('Member has joined a server')
...
bot.on('guildCreate', function () {
    const schannel = message.guild.channels.find('624555907447259146'); schannel.send('Bot was added to server')
...
bot.on('guildDelete', function () {
    const schannel = message.guild.channels.find('624555907447259146'); schannel.send('Bot removed from server')
    bot.user.setActivity('' + bot.guilds.size + ' servers @Automatic help', {
        type: 'LISTENING'
    })
})
